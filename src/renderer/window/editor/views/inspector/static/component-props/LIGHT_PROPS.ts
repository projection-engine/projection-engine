...
export default [
	...
	group("AREA_LIGHT", [
		number("RADIUS", "areaRadius", undefined, 0, undefined,undefined,undefined,comp => comp.type === LightTypes.PLANE),

		number("WIDTH", "planeAreaWidth", undefined, 0, undefined,undefined,undefined,comp => comp.type !== LightTypes.PLANE),
		number("HEIGHT", "planeAreaHeight", undefined, 0, undefined,undefined,undefined,comp => comp.type !== LightTypes.PLANE)
	...
	group("CUTOFF", [
		...
		number("RADIUS", "radius", 180, 1, .01, undefined, undefined, comp => comp.type !== LightTypes.SPOT),
	], comp => comp.type === LightTypes.DIRECTIONAL),

	group("SHADOWS", [
		boolean("ENABLED", "shadowMap"),
		number("SIZE", "size", undefined, 1, undefined, false, false, comp => !comp.shadowMap || comp.type !== LightTypes.DIRECTIONAL),
