...
export default class Movable {
	...
	static get ROTATION_EULER_XYZ() {
		return 1
	}

	static get ROTATION_EULER_XZY() {
		return 2
	}

	static get ROTATION_EULER_YXZ() {
		return 3
	}

	static get ROTATION_EULER_YZX() {
		return 4
	}

	static get ROTATION_EULER_ZXY() {
		return 5
	}

	static get ROTATION_EULER_ZYX() {
		return 6
	}
