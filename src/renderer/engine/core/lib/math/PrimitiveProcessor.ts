...
export default class PrimitiveProcessor {
    static computeNormals(indices: Float32Array | number[], vertices: Float32Array | number[]): number[] {
        if (!indices || !vertices)
            return []
    ...
    static computeTangents(indices: Float32Array | number[], vertices: Float32Array | number[], uvs: Float32Array | number[], normals: Float32Array | number[]): number[] {
    ...
    static computeBoundingBox(vertices: Float32Array | number[]): [number[], number[]] {
