...
export default {
    ...
    BASIC: "Basic",
    ENTITY_PROPERTIES: "EditorEntity properties",
    ...
    SSAO: "AmbientOcclusionSystem (Ambient occlusion)",
    ...
    AO_SRC: "Unfiltered AmbientOcclusionSystem",
    ...
    HEIGHT: "Height",
    DIRECTION: "Direction",
    PHYSICS_COLLIDER: "PhysicsSystem collider",
    ...
    FOCUSED_ON_ENGINE: "Priority on: EditorEntity",
    ...
    STEP_SIZE: "Step size",
    STEPS: "Steps",
    SSGI: "GlobalIlluminationSystem (Global illumination)",
    SHADOWS: "Shadows",
    LIGHTS: "Lights",
