...
export default function Hierarchy(){
    ...
    return (
        <>
            <ViewWrapper.Header  title={"Hierarchy"} icon={"account_tree"}>
            ...
            <TreeView
                ...
                nodes={data}
                handleRename={(treeNode, newName) => engine.dispatchEntities({type: ENTITY_ACTIONS.UPDATE, payload: {entityID: treeNode.id, key: "name", data: newName}})}
            />
        </>
    )
}