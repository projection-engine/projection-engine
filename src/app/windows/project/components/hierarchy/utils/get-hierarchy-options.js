    ...
    return [
        {
            ...
            onClick: () => createFolder(StoreController.engine.dispatchEntities)
        },
        ...
        },
        {
            ...
            onClick: (node) => {
                ...
                }, {...StoreController.engine, selected: []})
        ...
        {divider: true},
        {
            ...
            onClick: (target) => {
                const t = target.getAttribute("data-node")
                StoreController.updateEngine({...StoreController.engine, selected: StoreController.engine.selected.filter(s => s !== t)})
            }
        },
        {
            requiredTrigger: "data-node",
            ...
            onClick: (target) => {
                ...
                StoreController.updateEngine({...StoreController.engine, selected: StoreController.engine.selected.filter(s => toDeselect.includes(s))})
            }
        },
        {divider: true},
        {
            ...
            onClick: (target) => {
                const t = target.getAttribute("data-node")
                StoreController.updateEngine({...StoreController.engine, selected:[... StoreController.engine.selected, t] })
            }
        },
        {
            requiredTrigger: "data-node",
            ...
            onClick: (target) => {
                ...
                StoreController.updateEngine({...StoreController.engine, selected:[...StoreController.engine.selected, ...toSelect] })
            }
        },
        {
            requiredTrigger: "data-node",
