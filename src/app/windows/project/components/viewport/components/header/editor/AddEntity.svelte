...
<Dropdown>
    ...
    <button on:click={(e) => createMesh(STATIC_MESHES.CUBE, e)}>
        <Icon>category</Icon>
        {translate("CUBE")}
    </button>
    <button on:click={(e) => createMesh(STATIC_MESHES.SPHERE, e)}>
        <Icon>category</Icon>
        {translate("ICO_SPHERE")}
    </button>
    <button on:click={(e) => createMesh(STATIC_MESHES.PLANE, e)}>
        <Icon>category</Icon>
        {translate("PLANE")}
    </button>
    <button on:click={(e) => createMesh(STATIC_MESHES.CYLINDER, e)}>
        <Icon>category</Icon>
        {translate("CYLINDER")}
    </button>
