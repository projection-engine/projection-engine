...
<Dropdown>
    <button data-sveltebuttondefault="-"  slot="button" class="button frame" style="max-width: unset; max-height: 18px; min-height: 18px;  background: transparent; padding: 0 4px;"
