...
export default [
    {
        ...
        form: [
            ...
            },
            {
                ...
                type: Component.propTypes.GROUP,
                children: [
                    {    target: "settings",type: Component.propTypes.BOOLEAN, label: LOCALIZATION_EN.GRID, key: "showGrid"},
                    {    target: "settings",type: Component.propTypes.BOOLEAN, label: LOCALIZATION_EN.ICONS, key: "showIcons"},
                    {    target: "settings",type: Component.propTypes.BOOLEAN, label: LOCALIZATION_EN.LINES, key: "showLines"},
                    {    target: "settings",type: Component.propTypes.BOOLEAN, label: LOCALIZATION_EN.OUTLINE, key: "showOutline"},
                    {divider: true},
                    {
